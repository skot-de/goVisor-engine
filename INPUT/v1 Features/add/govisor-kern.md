...
Rechtlich frei, weil noch kein Verfahren läuft. Hier entsteht der Bedarf, und er ist vorhersehbar — aus mehreren Signalquellen:

- **Der Zyklus selbst**: Ein Vertrag, der bald ausläuft, erzeugt bald eine Ausschreibung. Und mehr: Wer zum vierten Mal denselben Auftrag ausschreibt, zeigt über die Zyklen ein Muster — Volumen gestiegen, Losstruktur verändert, Gewinner zementiert oder wechselnd. Der Abgleich von Vergangenheit und Zukunft ist ein eigenes Signal.
- **Zugesagtes Geld**: Forschungsförderung, Haushaltstitel, EU-Strukturfonds, kommunale Investitionsbeschlüsse — Geld, das vergeben wird, bevor ausgeschrieben wird, ist oft Jahre vorher öffentlich.
- **Regeländerungen**: Ein neues Gesetz, eine Richtlinie, eine Norm löst eine Welle gleichartiger Ausschreibungen aus — planbar, mit Übergangsfrist, marktweit. Wer die Regel kennt, kennt die Welle Monate vorher. Das ist der breiteste Vorlauf-Signaltyp: Er wirkt nicht auf eine Stelle, sondern auf einen ganzen Markt.
...
## 6. Was goVisor uneinholbar macht

Jedes einzelne Analyse-Feature ist kopierbar. Der dauerhafte Vorsprung entsteht nicht aus Features, sondern aus zwei Schichten, die mit jedem Nutzer wachsen.

### Die Ergebnisdaten — der Graben, den kein Crawler schließt
...
### Die Ehrlichkeit — das Vertrauensfundament

goVisor zeigt lieber „unbekannt" als eine falsche Zahl. Jeder Wert trägt seine Herkunft: gemessen, geschätzt, unbekannt. Wo die Datenlage dünn ist, sagt goVisor das. In einem Markt voller behaupteter „Marktintelligenz" ist prüfbare Ehrlichkeit selbst ein Wettbewerbsvorteil — gegenüber einer Zielgruppe, die Bid Manager und Geschäftsführer sind und Übertreibung sofort erkennen.
