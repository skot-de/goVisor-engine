...
const TXT = {
  ...
  jahreBasis: "Grundlage: {n} Verfahren über {jahre} Jahre ({von}–{bis}). Das laufende Jahr {laufend} fehlt — es ist noch kein volles Jahr und läse sich als Einbruch.",
  serieAb: "ab {jahr}",
  ...
  achseNurFenster: "Die Jahresachse deckt dasselbe Fenster ab wie die Saison ({von}–{bis}). Die Historie bis {frueh} wird gesondert erzeugt (Schalter --ab-jahr), weil sie im täglichen Lauf zu lange braucht.",
} as const;
